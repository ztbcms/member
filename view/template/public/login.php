...
<div class="login_body">
  ...
  <div class="login_box">
    <div class="login_box_left">
      <form id="form1" action="{:api_url('Public/doLogin')}" method="post">
      <input id="refer" type="hidden" value="{$forward}" />
        ...
        <div class="site">
          ...
          <div class="info_list">
            ...
            <div class="vcode">
              <div class="noleft"> <img id="authCode" align="absmiddle" title="看不清？点击更换" src="{:api_url("Api/Checkcode/index","type=userlogin&code_len=4&font_size=14&width=80&height=24&font_color=&background=")}"> </div>
              <div class="reloadCode"> <a id="changeAuthCode" href="javascript:;">看不清？换一张</a> </div>
            </div>
          </div>
          </if>
          <div class="info_list">
            <div class="right"> <a href="{:api_url('Member/Index/lostpassword')}">忘记密码?</a> </div>
    ...
    <div  class="login_box_right">
      ...
      <div class="reg">
        <p>注册后，即可享受更多服务！</p>
        <a href="{:api_url('Index/register')}" class="home_btn"></a> </div>
      <div class="partner">
        <p class="tit">使用其他账号登录:</p>
        <if condition=" $Member_config['qq_akey'] && $Member_config['qq_skey'] ">
        <a href="{:api_url('Connectqq/index')}" class="qq_login"> </a>
        </if>
        <if condition=" $Member_config['sinawb_akey'] && $Member_config['sinawb_skey'] ">
        <a href="{:api_url('Connectsina/index')}" class="siina_weibo"> </a>
        </if>
      </div>
      <ul class="clearfix">
